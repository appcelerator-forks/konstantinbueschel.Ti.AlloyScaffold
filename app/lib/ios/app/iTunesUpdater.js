...
function open() {
	...
	// DEBUG
(function(){/*Ti.API.debug*/})('[iTunesUpdater]:Try to open App Store entry with scheme: ', scheme);
...
function reset() {
	...
	// DEB(function(){/*Ti.API.debug*/})('[iTunesUpdater]:Reset');
...
function _trigger(forced) {
    ...
    if (Ti.Platform.name !== 'iPhone OS') {
	    ...
	    // DEBUG
    (function(){/*Ti.API.debug*/})('[iTunesUpdater]:Platform is not iOS');
    ...
    if (!forced) {
        ...
        if (now - checked < (exports.daysBetween * 86400)) {
            ...
            // DEBUG
        (function(){/*Ti.API.debug*/})('[iTunesUpdater]:Checked less than "', exports.daysBetween, '" days ago.');
            return;
        }
    }
    ...
    _lookup(function (result) {
        ...
        if (_cmpVersion(result.version, Ti.App.version) <= 0) {
	        ...
	        // DEBUG
	    (function(){/*Ti.API.debug*/})('[iTunesUpdater]:No new version');
            return;
        }
        ...
        if (!forced) {
            ...
            if (never === result.version) {
	            ...
	            // DEBUG
            (function(){/*Ti.API.debug*/})('[iTunesUpdater]:Never ask again for this version');
                return;
...
function _lookup(_callback) {
	...
	// DEBUG
(function(){/*Ti.API.debug*/})('[iTunesUpdater]:Lookup URL', url);
