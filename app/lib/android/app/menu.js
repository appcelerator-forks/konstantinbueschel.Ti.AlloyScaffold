...
function Menu() {
	...
	if (_parent) {
		...
		// DEBU(function(){/*Ti.API.debug*/})('[AndroidMenu].constructor():_parent =', _parent.apiName, _parent.title, 'open?', _parent.isOpen, 'force open', arguments[1]);
		...
		switch (_parent.apiName) {
			...
			case 'Ti.UI.Window':
				...
				if (win.isOpen === true || arguments[1] === true) {
					...
					// DEBUG
	(function(){/*Ti.API.debug*/})('[AndroidMenu].constructor():Fire OPEN event on window');
			...
			case 'Ti.Android.Activity':
				...
				// DEBUG
(function(){/*Ti.API.debug*/})('[AndroidMenu].constructor():Initializes activity');
	...
	function _initializeActivity() {
		...
		// DEBUG(function(){/*Ti.API.debug*/})('[AndroidMenu]._initializeActivity()');
	...
	function _createMenuItems(args) {
		...
		// DEBUG(function(){/*Ti.API.debug*/})('[AndroidMenu]._createMenuItems()', 'args', JSON.stringify(args));
		...
		if (menu) {
			...
			// DEBUG
(function(){/*Ti.API.debug*/})('[AndroidMenu]._createMenuItems()', 'itemOptions', itemOptions, JSON.stringify(itemOptions));


			itemOptions.forEach(function(options) {

				// DEBUG
	(function(){/*Ti.API.debug*/})('[AndroidMenu]._createMenuItems():', Object.keys(options), 'onClick?', !!options.onClick);
	...
	function reloadMenu() {
		...
		// DEBUG(function(){/*Ti.API.debug*/})('[AndroidMenu].reloadMenu():activity =', activity);
	...
	$.add = function(options) {
		...
		// DEBUG(function(){/*Ti.API.debug*/})('[AndroidMenu].add():', 'menu', menu, 'activity', activity);
